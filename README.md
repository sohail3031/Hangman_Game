This classic game of Hangman is created with Python. In this game, a player has 5 chances to guess the each word. They also has 5 hints which helps them to guess the word.
